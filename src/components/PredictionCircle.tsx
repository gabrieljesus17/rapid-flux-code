...
export default function PredictionCircle() {
  ...
  const triggerPrediction = useCallback(() => {
    ...
    const entryTime = Math.floor(getRandom(10, 25));
    setTimer(entryTime);
    ...
    const predictionText = "✅ Sinal positivo: entrada recomendada";
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full gap-4">
      <h2 className="text-3xl font-bold">
        {predictionActive ? "Entrada disponível em:" : "Próxima Predição em:"}
      </h2>
      <p className="text-xl text-gray-400 h-6">
        {predictionActive ? "Predição detectada 🔥" : "Analisando predição..."}
      </p>
      ...
      >
        ...
        {predictionActive && (
          <div className="flex flex-col gap-4 mt-16">
            <p className="text-2xl font-semibold text-white">✅ Sinal positivo: entrada recomendada</p>
